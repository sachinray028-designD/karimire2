...
const FAQS = [
  ...
  { q: 'Can foreigners buy property in Dubai?', a: 'Yes. Non-UAE nationals can purchase freehold in designated zones — Downtown, Palm Jumeirah, Dubai Marina, Business Bay, Dubai Hills, Emaar Beachfront and many more. Freehold grants full ownership, transferable to heirs.' },
